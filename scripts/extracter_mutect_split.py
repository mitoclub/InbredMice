...
files=os.listdir("MutectVTSnpEff\\")

#prepath = "C:\\Users\\Abathur\\Desktop\\ParkPolGbam\\mutect_first\\"
prepath = "C:\\Users\\Abathur\\Desktop\\Science\\InbredMice\\new2\\MutectVTSnpEff\\"
prepath2 = "C:\\Users\\Abathur\\Desktop\\Science\\InbredMice\\new2\\MutectVTSnpEff_split\\"
...
for fi in files:
	...
	while True:
		...
		if len(assb) == 2:
			...
			# для всех альтернативных аллелей берем их нуклеотид и посчитанную частоту
			ass = assb[1]
			vafass = vaf[1]  # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
			nuc =  row[4]     #   row[4].split(",")[i]
